...
type InputSizeProps = Pick<FilledInputProps, 'size' | 'hiddenLabel'> & {
  ownerState?: { inputSize?: 'small' | 'medium' };
};

type InputBaseVariants = NonNullable<ComponentsVariants<Theme>['MuiInputBase']>;
type OutlinedInputVariants = NonNullable<ComponentsVariants<Theme>['MuiOutlinedInput']>;
type FilledInputVariants = NonNullable<ComponentsVariants<Theme>['MuiFilledInput']>;
...
const multilineInputVariants: InputBaseVariants = [
  {
    props: (props) => !!props.multiline,
    style: { padding: 0 },
  },
