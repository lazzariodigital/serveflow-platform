...
// ════════════════════════════════════════════════════════════════
// Similar to dashboard but with PUBLIC routes for booking/services
// ════════════════════════════════════════════════════════════════

// Public routes - no auth required (includes webapp-specific public pages)
const publicRoutes = [
  '/sign-in',
  '/sign-up',
  '/sso-callback',
...
function extractTenantSlug(host: string): string | null {
  // Development: demo.localhost:3001 → demo
